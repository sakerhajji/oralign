...
export const dict = {
  ...
  finder: {
    ...
    selectDay: { fr: "Choisissez un jour", en: "Choose a day", ar: "اختر يوماً" } as T,
    chooseTime: { fr: "Choisissez une heure", en: "Choose a time", ar: "اختر ساعة" } as T,
    morning: { fr: "Matin", en: "Morning", ar: "صباحاً" } as T,
    afternoon: { fr: "Après-midi", en: "Afternoon", ar: "بعد الظهر" } as T,
    evening: { fr: "Soir", en: "Evening", ar: "مساءً" } as T,
    bookIntro: {
      fr: "Sélectionnez un créneau, puis renseignez vos coordonnées.",
      en: "Pick a time, then enter your details.",
      ar: "اختر موعداً ثم أدخل معلوماتك.",
    } as T,
    slotsCount: { fr: "{n} créneaux", en: "{n} slots", ar: "{n} مواعيد" } as T,
    ...
    successNextTitle: { fr: "Et ensuite ?", en: "What happens next", ar: "ماذا بعد؟" } as T,
    successStep1: {
      fr: "Le praticien examine votre demande de rendez-vous.",
      en: "The practitioner reviews your appointment request.",
      ar: "يراجع الطبيب طلب موعدك.",
    } as T,
    successStep2: {
      fr: "Vous recevez un e-mail dès qu’elle est confirmée.",
      en: "You’ll receive an email as soon as it’s confirmed.",
      ar: "ستصلك رسالة بريد إلكتروني بمجرد تأكيدها.",
    } as T,
