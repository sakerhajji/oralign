...
/**
 * Portalled, collision-aware floating panel. Unlike a hand-rolled portal,
 * Radix layers it correctly inside a modal Dialog (the dialog's pointer
 * lock and focus trap both account for it).
 */
