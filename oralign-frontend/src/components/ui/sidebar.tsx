      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t('uiBits.sidebarSrTitle')}</SheetTitle>
            <SheetDescription>{t('uiBits.sidebarSrDesc')}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{t('uiBits.toggleSidebar')}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={t('uiBits.toggleSidebar')}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t('uiBits.toggleSidebar')}
      className={cn(
