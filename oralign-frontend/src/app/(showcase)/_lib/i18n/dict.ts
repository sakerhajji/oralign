...
export const dict = {
  ...
  nav: {
    forDentists: { fr: "Symptômes", en: "Signs", ar: "الأعراض" } as T,
    howItWorks: { fr: "Le parcours", en: "Your journey", ar: "المسار" } as T,
    ...
    forPatients: { fr: "Témoignages", en: "Reviews", ar: "آراء" } as T,
